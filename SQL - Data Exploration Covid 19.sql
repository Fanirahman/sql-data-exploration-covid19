...
Select continent, Location, date, total_deaths, Population, (total_deaths/population)*100 AS TotalDeaths
FROM PortfolioProject..CovidDeaths
where continent is not null
order by 1,2
...
USE PortfolioProject
GO
Create View TotalDeathCountLoc as
Select Location, MAX(cast(total_deaths as int)) as TotalDeathCount
FROM PortfolioProject..CovidDeaths
--Where Location = 'United States'
where continent is not null
...
USE PortfolioProject
GO
Create View TotalDeathbyDate as
Select continent, Location, date, total_deaths, Population, (total_deaths/population)*100 AS TotalDeaths
FROM PortfolioProject..CovidDeaths
where continent is not null
--order by 1,2